!function(modules) {
    ...
    exports.Renderer = renderer_1.default, exports.marki = marki;
}, function(module, exports, __webpack_require__) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: !0
    });
    var marked = __webpack_require__(2), Lexer = function() {
        function Lexer(lexerOptions) {
            this.lexer = new marked.Lexer();
        }
        return Lexer.prototype.lex = function(source) {
    ...
    var Parser = function() {
        ...
        return Parser.prototype.parse = function(src, options) {
            return "";
        }, Parser;
    }();
    ...
    var Renderer = function() {
        function Renderer(options) {}
        return Renderer.prototype.code = function(code, language, isEscaped) {
            return "";
        }, Renderer.prototype.blockquote = function(quote) {
            return "";
        }, Renderer.prototype.html = function(html) {
