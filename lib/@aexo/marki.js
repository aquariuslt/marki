!function(root, factory) {
    "object" == typeof exports && "object" == typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define([], factory) : "object" == typeof exports ? exports["@aexo/marki"] = factory() : root["@aexo/marki"] = factory();
    ...
    return function(modules) {
        ...
        var _marked = __webpack_require__(1), _marked2 = function(obj) {
            return obj && obj.__esModule ? obj : {
                default: obj
            };
        }(_marked), marki = _marked2.default;
        marki.loadConfig = function() {}, exports.default = marki;
    }, function(module, exports, __webpack_require__) {
        (function(global) {
            (function() {
                ...
                function resolveUrl(base, href) {
                    return baseUrls[" " + base] || (/^[^:]+:\/*[^\/]*$/.test(base) ? baseUrls[" " + base] = base + "/" : baseUrls[" " + base] = base.replace(/[^\/]*$/, "")), 
                    base = baseUrls[" " + base], "//" === href.slice(0, 2) ? base.replace(/:[^]*/, ":") + href : "/" === href.charAt(0) ? base.replace(/(:\/*[^\/]*)[^]*/, "$1") + href : base + href;
                }
                function noop() {}
                function merge(obj) {
                ...
                inline.pedantic = merge({}, inline.normal, {
                    ...
                    "@" === cap[2] ? (text = escape(":" === cap[1].charAt(6) ? this.mangle(cap[1].substring(7)) : this.mangle(cap[1])), 
                    ...
                    if (this.options.sanitize) {
                        ...
                        if (0 === prot.indexOf("javascript:") || 0 === prot.indexOf("vbscript:") || 0 === prot.indexOf("data:")) return "";
                    }
                    this.options.baseUrl && !originIndependentUrl.test(href) && (href = resolveUrl(this.options.baseUrl, href));
                    var out = '<a href="' + href + '"';
                ...
                }, baseUrls = {}, originIndependentUrl = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i, noop.exec = noop, 
